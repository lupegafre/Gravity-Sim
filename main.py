...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def draw_body_labels(self, body, i): # repeating code, improve later
        if self.draw_info_screen:
            ...
            if self.draw_labels == 1: # draw all
                if len(self.celestialBodyList) <= 10: # don't draw all if more than 10 objetcs
            ...
            elif self.draw_labels == 2: # draw on hover
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def draw_body_distance_lines(self, body): # broken, not 3d
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def set_orbital_velocities(self): # not working anymore
        angle = math.pi / 2
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def draw_background(self): # not efficient AT ALL
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def draw_grid(self): 
        if self.draw_info_screen: # repeating code, improve
            if self.draw_screen_lines == 1: # HUGE performance hit, should skip every other line when zoomed out
                ...
                for i in range(int(number_lines)):
                    ...
                    if num_position % 100 == 0: # draw in increments of 100
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    def draw_engine_ui(self):
        ...
        # UI, change shortcuts to match these strings
        grid_text = 'none'
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    # DESTROY BODIES THAT COLLIDED SEVERAL TIMES IN A ROW AT THE END OF EACH FRAME
...
#—————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    # DRAW CENTER OF MASS OF THE UNIVERSE (AN X)
